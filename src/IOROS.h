...
#include "geometry_msgs/Twist.h"  // <--- 【修改点 1】加在第 7 行左右
...
void cmdVelCallback(const geometry_msgs::Twist::ConstPtr& msg); // <--- 【修改点 2】加在 public 里
...
ros::Subscriber _cmd_vel_sub; // <--- 【修改点 3】加在 private 里
